...
const ContactsPanel: React.FC<ContactsPanelProps> = ({ friends, onOpenConversation }) => {
  ...
  return (
    <aside className="w-72 flex-shrink-0 hidden lg:block p-4">
      <div className="bg-black/20 backdrop-blur-md border border-fuchsia-500/20 p-4 rounded-lg h-full flex flex-col">
